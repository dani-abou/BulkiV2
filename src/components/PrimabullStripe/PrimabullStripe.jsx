...
function PrimabullStripeProvider({ children }) {
...
export default function PrimabullStripeInElements({ price, children }) {
  ...
  return <> {clientSecret &&
    <Elements options={options} stripe={stripePromise}>
      <PrimabullStripeProvider>{children}</PrimabullStripeProvider>
    </Elements>
  }
  </>
}
